...
<h4 class="page-header">My Schedule</h4>
</section>
...
<!-- Custom Tabs -->
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#tab_2" data-toggle="tab">Upcoming Appointments</a></li> 
                        <li><a href="#tab_3" data-toggle="tab">Past Appointments</a></li> 
        </ul>
	...
	<?php include '_framework_table_data.php'; ?>
            </div><!-- /.tab-pane -->       
