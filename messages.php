...
<h4 class="page-header">Messages</h2>
</section>

<!-- Begin Single Column Layout -->
<section class="content"><div class="mailbox row"><div class="col-xs-12"><div class="box box-solid">
<div class="box-body">
                <div class="row">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-mailbox">
                                <tr class="unread">
                                    ...
                                    <td class="name"><a href="#">Dave Trainer</a></td>
                                    <td class="subject"><a href="#">Your next workout details</a></td>
