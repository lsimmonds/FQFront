...
<head>
<meta charset="UTF-8">
<title>FitQik | My Dashboard</title>
...
<h4 class="page-header">My Dashboard</h4>
</section>
...
<div class="col-sm-9"><!-- Custom Tabs -->
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab">My Profile</a></li>
            <li><a href="#tab_2" data-toggle="tab">My Goals</a></li>
            <li><a href="#tab_3" data-toggle="tab">My Equipment</a></li>   
        </ul>
